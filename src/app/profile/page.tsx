  ...
  return (
    <>
      <AppContainer>
        <div className="pb-20">
          {/* Profile Header */}
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-6 text-white -mx-4 sm:-mx-6 lg:-mx-8">
            <div className="flex items-center space-x-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
